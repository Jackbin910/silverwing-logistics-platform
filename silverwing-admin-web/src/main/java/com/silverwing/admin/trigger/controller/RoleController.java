...
public class RoleController {
    ...
    @GetMapping("/list")
    public Result<PageResult<SysRoleAggregate>> list(RoleQuery query) {
    ...
    @GetMapping("/all")
    public Result<List<SysRoleAggregate>> listAllEnabled() {
    ...
    @GetMapping("/{id}")
    public Result<SysRoleAggregate> getById(@PathVariable Long id) {
    ...
    @PostMapping
    public Result<SysRoleAggregate> create(@Valid @RequestBody SaveRoleCommand command) {
